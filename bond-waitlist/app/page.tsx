      ...
      <main className="flex-1">
        ...
        <section className="relative max-w-6xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.35, boxShadow: "0 8px 30px rgba(249,115,22,0.35)" }}
            whileTap={{ scale: 0.97 }}
              ...
              {[
                {
                  // icon: "🍜",
                  title: "Discover",
                  body: "Find restaurants and hotspots your whole group will love — filtered by your preferences.",
                  delay: 0,
                },
                {
                  // icon: "🗓️",
                  title: "Plan Together",
                  body: "Bond chooses your destination, you pick a time, and loop everyone in — no more endless group chats.",
                  delay: 0.1,
                },
                {
                  // icon: "🎉",
              ...
              // ].map(({ icon, title, body, delay }) => (
                ...
                <FadeUp key={title} delay={delay}>
                  <motion.div
                    ...
                    // whileHover={{ blockSize: "300px", fontSize: "24px"}}
                    whileHover={{ scaleX: 1.3, scaleY: 1.4, zIndex: 10, border: "2px solid var(--color-orange-500)"}}
        ...
        <section className="max-w-3xl mx-auto px-6 py-20 text-center">
          <FadeUp>
            ...
            <p className="text-lg text-gray-500 leading-relaxed">
              {"We built Bond because making plans with friends shouldn't feel like a chore. Our goal is simple: make it effortless for people to get off their phones and actually spend time together in the real world."}
            </p>
          </FadeUp>
        </section>
          ...
          <FadeUp>
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-gray-500">
                Be the first to know when Bond launches. 
              </p>
            </div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                ...
                <div>
                  <input
                    {...register("profession")}
                    placeholder="Profession (e.g. Student, Software Engineer, etc)"
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-shadow"
                  />
                  {errors.profession && (
